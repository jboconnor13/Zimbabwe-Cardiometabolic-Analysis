...
```{r}
#All counfounders
conf_vars_all <- as.character(t1_data_bw_selected$Predictor[which(t1_data_bw_selected$padj<0.05)])

#Confounders for specific variables 
conf_vars_HDL <- as.character(t1_data_bw_selected$Predictor[which(t1_data_bw_selected$padj<0.05 & t1_data_bw_selected$Outcome=="HDL")])
conf_vars_LDL <- as.character(t1_data_bw_selected$Predictor[which(t1_data_bw_selected$padj<0.05 & t1_data_bw_selected$Outcome=="LDL")])
conf_vars_Trig <- as.character(t1_data_bw_selected$Predictor[which(t1_data_bw_selected$padj<0.05 & t1_data_bw_selected$Outcome=="Trig")])
conf_vars_Glucose <- as.character(t1_data_bw_selected$Predictor[which(t1_data_bw_selected$padj<0.05 & t1_data_bw_selected$Outcome=="Glucose")])

conf_vars <- list(conf_vars_all=conf_vars_all,
                  conf_vars_HDL=conf_vars_HDL,
...
#Age Scatter plots
#LDL and Age
Glucose_Age_Plot <- ggplot(data=base_t1, mapping=aes(x=Visit_Age, y=Glucose, fill=Cohort)) +
  ...
  scale_color_manual(values=c(cohortColors[1],
    ...
    geom_smooth(aes(x=base_t1$Visit_Age, y=base_t1$Glucose), 
                method="lm", se=TRUE, inherit.aes=FALSE) +
        theme_bw() +
        labs(y="Glucose (mg/dL)",x="Age (years)", tag="B") +
        theme(legend.position = "bottom",
...
saveRDS(Glucose_Age_Plot, file = "../../Figures/Panels/FIGS1B.RDS")
...
LDL_Age_Plot <- ggplot(data=base_t1, mapping=aes(x=Visit_Age, y=LDL, fill=Cohort)) +
  ...
  scale_color_manual(values=c(cohortColors[1],
    ...
    geom_smooth(aes(x=base_t1$Visit_Age, y=base_t1$LDL), 
                method="lm", se=TRUE, inherit.aes=FALSE) +
        theme_bw() +
        labs(y="LDL-C (mg/dL)",x="Age (years)", tag="C") +
        theme(legend.position = "bottom",
              legend.text = element_text(size=15),
              legend.title = element_blank(),
          axis.text.x = element_text(size = 12),
...
saveRDS(LDL_Age_Plot, file = "../../Figures/Panels/FIGS1C.RDS")
...
Trig_Age_Plot <- ggplot(data=base_t1, mapping=aes(x=Visit_Age, y=Trig, fill=Cohort)) +
  ...
  scale_color_manual(values=c(cohortColors[1],
    ...
    geom_smooth(aes(x=base_t1$Visit_Age, y=base_t1$Trig), 
                method="lm", se=TRUE, inherit.aes=FALSE) +
        theme_bw() +
        labs(y="Triglycerides (mg/dL)",x="Age (years)", tag="D") +
        theme(legend.position = "bottom",
              legend.text = element_text(size=15),
              legend.title = element_blank(),
          axis.text.x = element_text(size = 12),
...
saveRDS(Trig_Age_Plot, file = "../../Figures/Panels/FIGS1D.RDS")
