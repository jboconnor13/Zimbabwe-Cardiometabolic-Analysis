...
Ent_Blast_data_add <- Ent_Blast_data[,c("SampleID","Blastocystis","Entamoeba")]
...
metadata_objects <- c("base", "long")
saveRDS(metadata_objects, file = "important_objects.RData")

# A list of all objects in your current workspace
all_objects <- ls()
rm(list = all_objects)
