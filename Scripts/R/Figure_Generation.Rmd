...
###Figure S2
```{r}
#Results of linear mixed effects models relating inflammation to cardiometabolic outcomes in all participants (Fig S2A) and naive participants (Sig S2B)

FigS2 <- ggarrange(FIGS2A, FIGS2B, common.legend = TRUE, legend="bottom")
