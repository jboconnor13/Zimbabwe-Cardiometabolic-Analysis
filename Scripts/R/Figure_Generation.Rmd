...
FIG2G <- readRDS("~/Zimbabwe-Cardiometabolic-Analysis/Figures/Panels/FIG2G.RDS")
...
#Figure 3
FIG3A <- readRDS("~/Zimbabwe-Cardiometabolic-Analysis/Figures/Panels/FIG3A.RDS")
FIG3B <- readRDS("~/Zimbabwe-Cardiometabolic-Analysis/Figures/Panels/FIG3B.RDS")
FIG3C <- readRDS("~/Zimbabwe-Cardiometabolic-Analysis/Figures/Panels/FIG3C.RDS")
FIG3D <- readRDS("~/Zimbabwe-Cardiometabolic-Analysis/Figures/Panels/FIG3D.RDS")
FIG3E <- readRDS("~/Zimbabwe-Cardiometabolic-Analysis/Figures/Panels/FIG3E.RDS")
FIG3F <- readRDS("~/Zimbabwe-Cardiometabolic-Analysis/Figures/Panels/FIG3F.RDS")
FIG3G <- readRDS("~/Zimbabwe-Cardiometabolic-Analysis/Figures/Panels/FIG3G.RDS")
...
saveRDS(FigS2, file = "../../Figures/Finals/FigS2.RDS")
...
Fig2FG <- ggarrange(FIG2F, FIG2G, nrow=2)

Fig2 <- ggarrange(Fig2AB,Fig2CDE,Fig2FG, widths=c(1.5,1.5,1), nrow=1, ncol=3)

saveRDS(Fig2, file = "../../Figures/Finals/Fig2.RDS")
...
FigS3CD <- ggarrange(FIGS3C,FIGS3D, nrow=2)

FigS3 <- ggarrange(FIGS3A, FIGS3B, FigS3CD, nrow=1, widths=c(1,1.5,1))

saveRDS(FigS3, file = "../../Figures/Finals/FigS3.RDS")
...
FigS45FG <- ggarrange(FIGS4F, FIGS4G, nrow=2)
...
Fig3ABC <- ggarrange(FIG3A,FIG3B,FIG3C, nrow = 1)

Fig3DE <- ggarrange(FIG3D,FIG3E, nrow=2)

Fig3DEFG <- ggarrange(Fig3DE, FIG3F,FIG3G, nrow=1, widths=c(1,1,2))

Fig3 <- ggarrange(Fig3ABC, Fig3DEFG, nrow=2)
