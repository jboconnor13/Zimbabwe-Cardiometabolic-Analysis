...
met_stats_co$group1 <- factor(met_stats_co$group1, levels=c("Naïve", "Exp", "HC"), ordered=TRUE)
met_stats_co$group2 <- factor(met_stats_co$group2, levels=c("Naïve", "Exp", "HC"), ordered=TRUE)
...
met_stats_long$Cohort <- factor(met_stats_long$Cohort, levels=c("Naïve", "Exp", "HC"), ordered=TRUE)
...
base_met_long$Cohort <- factor(base_met_long$Cohort, levels=c("Naïve", "Exp", "HC"), ordered=TRUE)
